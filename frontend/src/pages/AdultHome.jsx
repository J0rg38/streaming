...
import { ArrowLeft, LogOut, Lock, Play, Info, Flame, Search, Home as HomeIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black pb-12 text-white">
      ...
      <nav className="fixed top-0 z-30 flex w-full items-center justify-between bg-gradient-to-b from-black via-black/70 to-transparent px-4 py-3 sm:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link to="/adultos" className="flex items-center gap-2 rounded bg-white/10 px-3 py-2 text-sm font-medium backdrop-blur hover:bg-white/20 sm:px-4" title="Inicio +18">
      ...
      {loading ? (
      ...
      ) : banner.length === 0 && rails.length === 0 && featured.length === 0 && discovery.length === 0 && continueWatching.length === 0 && comingSoon.length === 0 ? (
        ...
        <>
          ...
          <div className="relative z-10 mt-4">
            ...
            {comingSoon.length > 0 && <Carousel title="🔜 Próximamente" items={comingSoon} />}

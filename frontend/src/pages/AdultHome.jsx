...
export default function AdultHome() {
  ...
  return (
    <div className="min-h-screen bg-black pb-12">
      ...
      <nav className="sticky top-0 z-30 flex items-center justify-between border-b border-red-900/40 bg-black/90 px-4 py-3 backdrop-blur sm:px-8">
      ...
      {/* -------- Encabezado -------- */}
      <div className="border-b border-red-900/30 bg-gradient-to-b from-red-950/40 to-transparent px-4 py-8 sm:px-8">
